...
export const SKILL_TREE: SkillUnit[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        icon: '🎯',
        prerequisites: [],
        lessonIds: ['sql-where-1', 'sql-where-2', 'sql-where-3', 'sql-where-4', 'sql-where-5', 'sql-where-6'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '🔤',
        prerequisites: [],
        lessonIds: ['sql-like-1', 'sql-null-1', 'sql-null-2', 'sql-null-3', 'sql-distinct-1', 'sql-distinct-2'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '📈',
        prerequisites: [],
        lessonIds: ['sql-group-1', 'sql-group-2', 'sql-group-3', 'sql-group-4', 'sql-order-1', 'sql-order-2', 'sql-order-3', 'sql-order-4', 'sql-having-1'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '🔢',
        prerequisites: [],
        lessonIds: ['sql-case-1', 'sql-case-2', 'sql-case-3', 'sql-case-4'],
        status: 'locked',
        progress: 0,
        teaching: [
    ...
    nodes: [
      {
        ...
        icon: '🔄',
        prerequisites: [],
        lessonIds: ['sql-inner-join-1', 'sql-inner-join-2', 'sql-inner-join-3', 'sql-inner-join-4', 'sql-cross-join-1'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '⬅️',
        prerequisites: [],
        lessonIds: ['sql-left-join-1', 'sql-left-join-2', 'sql-join-agg-1', 'sql-join-agg-2'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '🌐',
        prerequisites: [],
        lessonIds: ['sql-self-join-1', 'sql-self-join-2'],
        status: 'locked',
        progress: 0,
        teaching: [
    ...
    nodes: [
      {
        ...
        icon: '🏅',
        prerequisites: [],
        lessonIds: ['sql-rank-1', 'sql-rank-2', 'sql-row-number-1', 'sql-rank-3'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '⏮️',
        prerequisites: [],
        lessonIds: ['sql-lag-1', 'sql-lag-2', 'sql-lead-1'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '📊',
        prerequisites: [],
        lessonIds: ['sql-window-agg-1', 'sql-window-agg-2', 'sql-window-agg-3', 'sql-window-agg-4', 'sql-window-agg-5', 'sql-ntile-1'],
        status: 'locked',
        progress: 0,
        teaching: [
    ...
    nodes: [
      {
        ...
        icon: '📦',
        prerequisites: [],
        lessonIds: ['sql-subquery-1', 'sql-subquery-2', 'sql-subquery-3', 'sql-subquery-4', 'sql-subquery-5'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '🧩',
        prerequisites: [],
        lessonIds: ['sql-cte-1', 'sql-cte-2', 'sql-cte-3', 'sql-cte-4', 'sql-cte-5'],
        status: 'locked',
        progress: 0,
        teaching: [
      ...
      },
      {
        ...
        icon: '⚡',
        prerequisites: [],
        lessonIds: ['sql-set-1', 'sql-set-2', 'sql-set-3', 'sql-set-4', 'sql-str-1', 'sql-str-2', 'sql-str-3', 'sql-date-1', 'sql-date-2', 'sql-date-3', 'sql-date-4', 'sql-view-1', 'sql-percentile-1', 'sql-pivot-1', 'sql-funnel-1', 'sql-cohort-1'],
        status: 'locked',
        progress: 0,
        teaching: [
